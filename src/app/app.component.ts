...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, CommonModule, HeaderComponent, FooterComponent, TopBarComponent],
  // imports: [RouterOutlet, CommonModule, TopBarComponent, HeaderComponent, HomeComponent, FooterComponent],
  standalone: true,
